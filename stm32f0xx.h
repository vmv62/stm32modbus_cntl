...
typedef struct
{
  ...
  uint16_t RESERVED1;         /*!< Reserved,                                                     0x06 */
    ...
    uint16_t WRP1;         /*!<FLASH option byte write protection 1,          Address offset: 0x0C */
} OB_TypeDef;
...
typedef struct
{
  uint32_t ISER;               /*!< Offset: 0x000 (R/W)  Interrupt Set Enable Register */
  uint32_t RESERVED0;
  uint32_t ICER;               /*!< Offset: 0x080 (R/W)  Interrupt Clear Enable Register */
  uint32_t RSERVED1;
  uint32_t ISPR;               /*!< Offset: 0x100 (R/W)  Interrupt Set Pending Register */
  uint32_t RESERVED2;
  uint32_t ICPR;               /*!< Offset: 0x180 (R/W)  Interrupt Clear Pending Register */
  uint32_t RESERVED3;
  uint32_t RESERVED4;
  uint32_t IP;                 /*!< Offset: 0x300 (R/W)  Interrupt Priority Register */
}  NVIC_TypeDef;
...
typedef struct
{
    ...
    uint32_t IOGXCR[6]; /*!< TSC I/O group x counter register,                         Address offset: 0x34-48 */
} TSC_TypeDef;
